...
from apps.rfacial.views.views import CRelacionPermisos

class Command(BaseCommand):
    help = 'El siguiente comando sirve para relacionar permisos de usuarios de IDIAI v1.'
    ...
    def handle(self, *args, **options):
        ...
        if sSistema!="":
            oInc = CRelacionPermisos()
            oInc.listarPermisos(sSistema)
        else:
            print("No ingreso correctamento los argumentos, por favor de verificar el uso del comando consultado  relacionarPermisos --help")
