...
class CAutenticacio(APIView):
    ...
    def get(self,request):
        ...
        #     datos = {'message': 'Conexi�n exitosa :)'}
        # else:
    ...
    def post(self,request):
        # Realiza la validaci�n de las credenciales de los usuarios.
        #Para realizar un consulta exitosa, env�a un objeto JSON con los siguientes campos:
        ...
        try:
            ...
            #Validaci�n de las claves json, si alguna clave no se encuentra en el objeto, entonces
            ...
            if bValido:
                ...
                #2. Compara el token obtenido del json contra el secretKey de la aplicaci�n.
                if(jd['token'] == os.environ.get('SECRET_KEY')):
                    ...
                    if sistema>0:
                        ...
                        #4. Verifica que la contrase�a en base64 coincida con la password encriptada de BD.
                        #En caso de coincidir es como devuelve los permisos y grupos del usuario.
                        if  handler.verify(pwdD64,password):
                            # print("Las contrase�as son iguales")
